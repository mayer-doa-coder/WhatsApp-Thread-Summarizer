    ...
    >
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="mt-2 text-2xl font-semibold text-gradient">Sign in to your workspace</h1>
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link to="/forgot-password" className="text-xs text-[var(--accent)] hover:underline" tabIndex={-1}>
                  Forgot password?
                </Link>
              </div>
              <input
            ...
            <label className="flex items-center gap-2.5 select-none">
              <div className="relative flex-shrink-0">
                ...
                <div className={[
                  ...
                  rememberMe ? 'bg-[var(--accent)] border-[var(--accent)]' : 'bg-white/[0.03] border-white/[0.15]',
                ].join(' ')} />
                {rememberMe && (
                  <svg className="absolute inset-0 w-4 h-4 text-slate-950 pointer-events-none" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth={2.5}>
